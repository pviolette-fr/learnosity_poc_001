 ...
 */
final class Version20200121102830 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE quiz_attempt CHANGE score score INT NOT NULL, CHANGE submitted_at submitted_at DATETIME DEFAULT \'NULL\'');
    }
}
